                    ...
                    <div class="col-md-8 col-sm-7">
                         ...
                         <div class="news-detail-thumb">
                              <div class="news-image">
                                  ...
                                  <img src="assets/images/hospi1.jpg" class="img-responsive" alt="">
                              </div>
                    ...
                    <div class="col-md-4 col-sm-5">
                         <div class="news-sidebar">
                              <div class="news-author">
                                   <h4>Breton Village Animal Hospital</h4>
                                   ...
                                   <h4>Contact us</h4>
                                        ...
                                        <div class="media">
                                             <div class="media-object pull-left">
                                                 <a href="#"><img src="assets/images/call.png" class="img-responsive" alt=""></a>
                                             </div>
                                             <div class="media-body">
                                                  <h4 class="media-heading"><a href="#">+91 45782215312</a></h4>
                                             </div>
                                        </div>

                                        <div class="media">
                                             <div class="media-object pull-left">
                                                 <a href="#"><img src="assets/images/email.png" class="img-responsive" alt=""></a>
                                             </div>
                                             <div class="media-body">
                                                  <h4 class="media-heading"><a href="#">doghospital@gmail.com</a></h4>
                                             </div>
                                        </div>
                                    <div class="media">
                                             <div class="media-object pull-left">
                                                 <a href="#"><img src="assets/images/addre.png" class="img-responsive" alt=""></a>
                                             </div>
                                             <div class="media-body">
                                                  <h4 class="media-heading"><a href="#">dosds sfsf sdsf aasddsfjm hwbgeyft whegftd asjkdbf</a></h4>
                                             </div>
                                        </div>
                              </div>
     ...
     <section id="appointment" data-stellar-background-ratio="3">
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <!-- CONTACT FORM HERE -->
                         <form id="appointment-form" action="mailto:kabadesanket1383@gmail.com" method="post" enctype="text/plain">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="date" name="want Apointment on Date" value="" class="form-control">
                                   </div>

                                   <div class="col-md-6 col-sm-6">
                                        <label for="select"  >Select Department</label>
                                        <select class="form-control" name="For What :">
